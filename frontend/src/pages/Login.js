  ...
  return (
    <div className="width-full h-[100vh]  bg-light-gray flex justify-items-center">
      <div className="flex absolute flex-col w-5/6 sm:w-[420px] mx-auto space-y-6 py-4 px-6 shadow-md bg-white left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
         ...
         <form onSubmit={handleSubmit} className="flex flex-col mx-auto space-y-2 w-full">
           ...
           <button disabled={loading} type="submit" className="disabled:opacity-50 mx-auto bg-green px-6 py-2 text-white font-semibold hover:opacity-80 duration-300">Log In</button>
         </form>
